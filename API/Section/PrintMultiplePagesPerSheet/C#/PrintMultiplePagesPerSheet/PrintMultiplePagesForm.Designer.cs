  ...
  private System.Windows.Forms.PrintDialog dlgPrint;
		...
		private void InitializeComponent()
		{
			...
			if (Environment.Version.Major < 6)
				this.splitContainer1.SplitterDistance = (int)(this.AutoScaleFactor.Width * this.splitContainer1.SplitterDistance);
			...
			if (Environment.Version.Major < 6)
				this.splitContainer2.SplitterDistance = (int)(this.AutoScaleFactor.Width * this.splitContainer2.SplitterDistance);

...
namespace ActiveReports.Samples.Designer
{
	internal partial class DesignerForm : Form
	{
		...
		public DesignerForm()
		{
            ...
            Icon = Resources.App;
			scale = new SizeF(this.AutoScaleDimensions.Width / 96F, this.AutoScaleDimensions.Height / 96F);
			...
			Shown += DesignerForm_Shown;

			AllowDrop = true;
			DragEnter += DesignerForm_DragEnter;
			DragDrop += DesignerForm_DragDrop;

			FormClosing += DesignerForm_Closing;
		}

        private void DesignerForm_Shown(object sender, EventArgs e)
		{
		...
		private void DesignerForm_Closing(object sender, FormClosingEventArgs e)
        {            

...
Partial Public Class DesignerForm
    ...
    Private _scale As SizeF = New SizeF(1.0F, 1.0F)
    ...
    Public Sub New()
        ...
        _scale = New SizeF(Me.AutoScaleDimensions.Width / 96.0F, Me.AutoScaleDimensions.Height / 96.0F)
        ...
        AddHandler Shown, AddressOf DesignerForm_Shown
        AllowDrop = True
        AddHandler DragEnter, AddressOf DesignerForm_DragEnter
        AddHandler DragDrop, AddressOf DesignerForm_DragDrop
        AddHandler FormClosing, AddressOf DesignerForm_Closing
    End Sub


    Private Sub DesignerForm_Shown(ByVal sender As Object, ByVal e As EventArgs)
        If Environment.Version.Major < 6 Then Fix(Me)
    End Sub

    Private Sub Fix(ByVal c As Control)
    ...
    Private Sub Fix(ByVal sp As SplitContainer)
    ...
    Private Sub DesignerForm_Closing(ByVal sender As Object, ByVal e As FormClosingEventArgs)

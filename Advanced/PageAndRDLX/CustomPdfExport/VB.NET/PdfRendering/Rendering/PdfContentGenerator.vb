...
#Region "IDrawingCanvas implementation"
	...
	Function CreateLinearGradientBrush(point1 As PointF, point2 As PointF, color1 As Color, color2 As Color, stops As IEnumerable(Of GradientStopColor)) As BrushEx Implements IDrawingCanvas.CreateLinearGradientBrush
		Return New LinearGradientBrush(point1, point2, color1, color2)
	End Function

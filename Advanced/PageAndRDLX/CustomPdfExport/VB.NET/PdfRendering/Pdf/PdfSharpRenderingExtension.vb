        ...
        Try
            ...
            Using outputStream = primaryStream.OpenStream()
                Using generator As New PdfGenerator(outputStream, pdfSettings.EmbedFonts)
                    ...
                    Dim generatorSettings As New PageGeneratorSettings() With {
                            .TargetDeviceKind = pdfSettings.Target,
                            .IncludePageMargins = True,
                            .PageSettings = New GrapeCity.ActiveReports.ImageRenderers.PageControl.PageControllerSettings() With {
                            .EndPage = endPage,
                            .StartPage = startPage
                            },

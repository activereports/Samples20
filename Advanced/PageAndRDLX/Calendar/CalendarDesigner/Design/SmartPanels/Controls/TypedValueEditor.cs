...
namespace ActiveReports.Calendar.Design.SmartPanels.Controls
{
	/// <summary>
	...
	internal class TypedValueEditor : VerticalPanel, IPresenter
	{
		...
		public ExpressionInfo ValueAsExpression
		{
			get
			{
				ExpressionInfo expression = Value as ExpressionInfo ?? ExpressionInfo.FromString("", ExpressionResultType.Variant);
	...
	internal static class TypedValueEditControlFactory
	{
		...
		public sealed class TextBoxControl : TextBoxEx, IEditControlView
		{
			private readonly IPresenter _presenter;

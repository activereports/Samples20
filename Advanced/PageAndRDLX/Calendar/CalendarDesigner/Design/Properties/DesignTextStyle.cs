using ActiveReports.Calendar.Design.Converters;
using ActiveReports.Calendar.Validation;
...
using GrapeCity.ActiveReports.PageReportModel.Validation;
...
using System.Text;
using ColorExpressionInfoConverter = ActiveReports.Calendar.Design.Converters.ColorExpressionInfoConverter;
using EnumExpressionInfoConverter = ActiveReports.Calendar.Design.Converters.EnumExpressionInfoConverter;
using LengthExpressionInfoConverter = ActiveReports.Calendar.Design.Converters.LengthExpressionInfoConverter;
using NullableColorExpressionInfoConverter = ActiveReports.Calendar.Design.Converters.NullableColorExpressionInfoConverter;
using NullableEnumExpressionInfoConverter = ActiveReports.Calendar.Design.Converters.NullableEnumExpressionInfoConverter;
using NullableLengthExpressionInfoConverter = ActiveReports.Calendar.Design.Converters.NullableLengthExpressionInfoConverter;
...
namespace ActiveReports.Calendar.Design.Properties
{
	...
	internal struct DesignTextStyle : IComparable, IValidatable
	{
		...
		/// </summary>
		[ExpressionBaseTypeAttribute(typeof(GrapeCity.ActiveReports.Drawing.FontStyle))]
		[EditorAttribute(typeof(ExpressionInfoUITypeEditor), typeof(UITypeEditor))]
		...
		/// </summary>
		[ExpressionBaseTypeAttribute(typeof(GrapeCity.ActiveReports.Drawing.FontWeight))]
		[EditorAttribute(typeof(ExpressionInfoUITypeEditor), typeof(UITypeEditor))]
		...
		{
            ValidationUtils.ValidateLength(Size, _minSize, _maxSize);
		}

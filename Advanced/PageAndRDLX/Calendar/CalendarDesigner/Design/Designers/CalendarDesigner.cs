using ActiveReports.Calendar.Components.Calendar;
using ActiveReports.Calendar.Design.Properties;
using ActiveReports.Calendar.Design.SmartPanels.Calendar;
...
using BorderStyle = ActiveReports.Calendar.Components.Calendar.BorderStyle;
...
using Direction = ActiveReports.Calendar.Components.Calendar.Direction;
using Drillthrough = GrapeCity.ActiveReports.PageReportModel.Drillthrough;
using FieldsListVariantExpressionInfoConverter = ActiveReports.Calendar.Design.Converters.FieldsListVariantExpressionInfoConverter;
using FontStyle = GrapeCity.ActiveReports.Drawing.FontStyle;
using FontWeight = GrapeCity.ActiveReports.Drawing.FontWeight;
using TextAlign = ActiveReports.Calendar.Components.Calendar.TextAlign;
using VerticalAlign = ActiveReports.Calendar.Components.Calendar.VerticalAlign;
